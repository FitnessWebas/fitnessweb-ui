...
function Home() {
  ...
  return (
    <div className={styles.app}>
          ...
          <div className={styles.heroContent}>
            <div className={styles.heroText}>
              ...
              <div className={styles.buttonGroup}>
                <ActionButton
                  variant="primary"
                  onClick={() => navigate("/Workouts/Generator")}
                >
                  Create Workout <ArrowRight size={16} />
                </ActionButton>
                <ActionButton
                  variant="secondary"
                  onClick={() => navigate("/Exercises/Directory")}
                >
                  Browse Exercises
                </ActionButton>
              </div>
      ...
      <section className={styles.gradientWrapper}>
        {/* Features Section */}
          ...
          <div className={styles.container}>
            ...
            <div className={styles.stepsContainer}>
              ...
              <div className={styles.stepItem}>
                ...
                <p className={styles.stepDescription}>
                  Explore our extensive library of exercises categorized by
              ...
              <div className={styles.stepItem}>
                ...
                <p className={styles.stepDescription}>
                  Record your workouts and monitor your progression with
